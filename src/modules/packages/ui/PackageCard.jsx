...
export default function PackageCard({
  ...
  return (
    <li className="relative rounded-2xl bg-gray-800/70 border border-white/10 p-5 shadow-lg aspect-square flex flex-col justify-between transition hover:scale-[1.02]">
